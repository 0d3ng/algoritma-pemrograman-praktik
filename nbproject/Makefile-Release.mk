...
${OBJECTDIR}/Modul10/Modul10.o: Modul10/Modul10.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modul10/Modul10.o Modul10/Modul10.cpp

${OBJECTDIR}/Modul11/Modul11.o: Modul11/Modul11.cpp
	${MKDIR} -p ${OBJECTDIR}/Modul11
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modul11/Modul11.o Modul11/Modul11.cpp
...
${OBJECTDIR}/Modul5/Modul5.o: Modul5/Modul5.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modul5/Modul5.o Modul5/Modul5.cpp
...
${OBJECTDIR}/Modul8/Modul8.o: Modul8/Modul8.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modul8/Modul8.o Modul8/Modul8.cpp

${OBJECTDIR}/Modul9/Modul9.o: Modul9/Modul9.cpp
	${MKDIR} -p ${OBJECTDIR}/Modul9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Modul9/Modul9.o Modul9/Modul9.cpp
